...
python test.py polydet --test --exp_id hg32_pts --dataset cityscapes --nbr_points 32 --arch hourglass --keep_res --load_model /store/dev/CenterPoly/exp/cityscapes/polydet/hg_32pts/model_best.pth