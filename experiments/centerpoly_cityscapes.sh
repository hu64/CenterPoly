...
python test.py polydet --exp_id from_ctdet_smhg_1cnv_16 --nbr_points 16 --dataset cityscapes --arch smallhourglass  --load_model ../exp/cityscapes/polydet/from_ctdet_smhg_1cnv_16/model_best.pth