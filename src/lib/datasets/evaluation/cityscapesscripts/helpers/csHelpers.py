...
# Cityscapes modules
try:
    from datasets.evaluation.cityscapesscripts.helpers.annotation import Annotation
    from datasets.evaluation.cityscapesscripts.helpers.labels import labels, name2label, id2label, trainId2label, category2labels
